export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 comic-border bg-[oklch(0.65_0.18_145)] text-cream px-4 py-3 font-heading uppercase tracking-wider hover:-translate-y-1 transition-transform"
    >
